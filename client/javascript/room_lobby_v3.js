...
//****************************************** story 東西
	...
	var flow = Object()
	flow["need_go_on_figure_story"] = true
	flow["need_go_on_lobby_story"] = true
	...
	// 原本，按下 story skip，
	// 關閉 lobby story ，視情況，是否進入 figure story
	async function skip_func(need_go_on_figure_story){
		...
		if(flow["need_go_on_figure_story"]){
			console.log("\n\nFFFFFFFFF\n\n")
			
			
			$("#figure_story_frame").css({
					display:"block",
					visibility:"visible",
					opacity:"1",
					width:"100%",
			...
			$("#figure_story_frame").prop("src","/test")
			//console.log("\n\nZZZZZZZ\n\n")
			await delay(50000)
			//console.log("\n\nZZZZZZZ\n\n")
	...
	async function init_figure_story(go_on_story,need_close_lobby,need_close_story){
		...
		*/
		...
		//console.log("\n\nMMMMMMMMMMMM\n\n")
		$("#figure_story , #Scrol1 , #Scrol1_in , #book , #images , #fac_flag , #say , #name").animate({
					display:"none",
					visibility:"hidden",
					opacity:"0",
				},1000)
	...
	async function close_figure_story(go_on_story){
